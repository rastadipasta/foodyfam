...
export function FloatingPhoto({
  ...
  return (
    <motion.div
      className="group relative aspect-[4/3] min-h-[260px] w-full min-w-0 max-w-full overflow-hidden rounded-[28px] shadow-[0_24px_70px_rgba(92,74,66,0.18)]"
      whileHover={{ y: -8, rotate: -0.4 }}
      transition={{ duration: 0.25 }}
    >
      <Image src={src} alt={title} fill sizes="(max-width: 768px) 100vw, 900px" className="object-cover transition duration-700 group-hover:scale-105" />
