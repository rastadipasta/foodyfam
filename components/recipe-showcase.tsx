...
export function RecipeShowcase({ recipe }: { recipe: Recipe }) {
  ...
  return (
    <KitchenLedger className="liquid-glass grid gap-6 overflow-hidden rounded-[34px] p-0 lg:grid-cols-[0.85fr_1.35fr]">
      ...
      <div className="grid gap-5 p-6">
        ...
        <div className="grid gap-5 lg:grid-cols-[1fr_1.2fr]">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <RecipeTicket className="rounded-[22px] bg-[#f7efe9]/62 p-5">
            ...
            <RecipeTicket className="rounded-[22px] bg-[#ffccb2]/58 p-5">
